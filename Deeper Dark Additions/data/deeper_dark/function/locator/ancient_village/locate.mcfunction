execute positioned ~1 ~ ~ store result score Game deeper_dark.distx+1 run locate structure deeper_dark:ancient_village
execute positioned ~-1 ~ ~ store result score Game deeper_dark.distx-1 run locate structure deeper_dark:ancient_village
execute positioned ~ ~ ~1 store result score Game deeper_dark.distz+1 run locate structure deeper_dark:ancient_village
execute positioned ~ ~ ~-1 store result score Game deeper_dark.distz-1 run locate structure deeper_dark:ancient_village
...
execute as @s positioned as @s run function deeper_dark:locator/ancient_village/locate