summon minecraft:ocelot ~ ~ ~ {Health:1000,PersistenceRequired:1b,Silent:1b,Tags:["rascal_ocelot"],active_effects:[{id:invisibility,duration:-1,show_particles:0b}],attributes:[{id:max_health,base:1000f},{id:movement_speed,base:0.2f}]}
