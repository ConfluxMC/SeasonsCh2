summon minecraft:ocelot ~ ~ ~ {CustomName:'Rascal',Health:200,PersistenceRequired:1b,Silent:1b,Tags:["rascal_ocelot"],active_effects:[{id:invisibility,duration:-1,show_particles:0b}],attributes:[{id:max_health,base:200f},{id:movement_speed,base:0.2f}]}

summon minecraft:armor_stand ~ ~ ~ {ShowArms:1b,Invisible:1b,Marker:1b,NoBasePlate:1b,Invulnerable:1b,NoGravity:1b,Tags:["rascal_stand"],equipment:{mainhand:{id:glow_item_frame,components:{custom_model_data:{strings:[rascal_1]}}},offhand:{id:glow_item_frame,components:{custom_model_data:{strings:[rascal_2]}}},head:{id:glow_item_frame,components:{custom_model_data:{strings:[rascal_body]}}}}}
