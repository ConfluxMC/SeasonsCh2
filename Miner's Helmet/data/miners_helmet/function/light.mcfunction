...
execute at @s unless entity @e[predicate=miners_helmet:wearing_miners_helmet,distance=..1] if block ~ ~1 ~ light[waterlogged=false] run setblock ~ ~1 ~ air
execute at @s unless entity @e[predicate=miners_helmet:wearing_miners_helmet,distance=..1] if block ~ ~ ~ light[waterlogged=true] run setblock ~ ~ ~ water
execute at @s unless entity @e[predicate=miners_helmet:wearing_miners_helmet,distance=..1] if block ~ ~1 ~ light[waterlogged=true] run setblock ~ ~1 ~ water



execute at @s unless entity @e[predicate=miners_helmet:wearing_miners_helmet,distance=..1] run function miners_helmet:silent_kill