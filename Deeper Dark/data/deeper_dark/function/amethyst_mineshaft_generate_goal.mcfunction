...
execute as @e[type=marker,tag=deeper_dark.amethyst_mineshaft_storage_room_active,limit=1,sort=random] at @s run function deeper_dark:amethyst_mineshaft_generate_goal_2
