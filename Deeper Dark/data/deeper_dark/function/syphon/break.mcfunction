...
tag @n[type=minecraft:item,distance=0...6,predicate=deeper_dark:item_sculk_catalyst] add deeper_dark.silent_despawn
execute as @n[type=minecraft:item,distance=0...6,predicate=deeper_dark:item_sculk_catalyst] run loot spawn ~ ~ ~ loot deeper_dark:items/sculk_syphon
