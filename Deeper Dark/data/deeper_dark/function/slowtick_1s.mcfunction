...
effect give @e[predicate=deeper_dark:in_volcanic_caverns] minecraft:jump_boost 3 4 true
effect give @e[predicate=deeper_dark:in_volcanic_caverns] minecraft:slow_falling 3 1 true
