...
execute positioned ^ ^ ^0.51 run tag @e[type=text_display,tag=deeper_dark.sonic_blaster_display,distance=0...1,limit=4,sort=nearest] add deeper_dark.silent_despawn
tag @e[type=text_display,tag=deeper_dark.sonic_blaster_display,distance=0...1,sort=nearest] add deeper_dark.silent_despawn
