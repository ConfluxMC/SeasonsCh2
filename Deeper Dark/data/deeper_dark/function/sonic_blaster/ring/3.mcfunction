#down
summon text_display ~ ~ ~ {view_range:0.2f,Tags:["deeper_dark.sonic_blaster_ring_3","deeper_dark.sonic_blaster_display"],background:0,line_width:800,alignment:"left",Rotation:[0F,90F],width:1f,height:1f,transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.0125f,-0.4751f,0.51f],scale:[0.5f,0.5f,0f]},text:[{"color":"#033b38","text":"                \n                \n    ■     ■     \n            ■   \n            ■   \n    ■           \n      ■ ■       \n                "}]}
