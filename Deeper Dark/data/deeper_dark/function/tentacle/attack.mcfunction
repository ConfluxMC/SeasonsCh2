...
execute as @n[type=minecraft:block_display,tag=deeper_dark.selected_all,tag=deeper_dark.tentacle_segment.1,distance=..10] at @s positioned ^ ^1.25 ^ run tp @n[type=minecraft:block_display,tag=deeper_dark.selected_all,tag=deeper_dark.tentacle_segment.2,distance=..10] ^ ^ ^.25
