execute positioned ~ ~-.1 ~ align xyz positioned ~.5 ~.5 ~.5 if entity @e[type=marker,tag=deeper_dark.sculk_converter,distance=0..1] run scoreboard players add @e[type=marker,tag=deeper_dark.sculk_converter,distance=0..1] deeper_dark.sculk_converter.fragments 1
