...
data modify storage deeper_dark:data PortalDestination set from entity @n[type=marker,tag=deeper_dark.portal_marker,distance=0..20] data.location
data modify storage deeper_dark:data PortalLocation.dim set from entity @n[type=marker,tag=deeper_dark.portal_marker,distance=0..20] data.location.dim
