execute positioned ~-.75 ~-.75 ~-.75 as @e[dx=0.5,dy=0.5,dz=0.5,predicate=deeper_dark:living,predicate=!deeper_dark:sculk_entity] run damage @s 50 minecraft:mob_attack by @n[type=ghast,tag=deeper_dark.boss_hitbox]
