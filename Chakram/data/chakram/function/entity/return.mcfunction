...
execute as @s[predicate=chakram:is_dark] if data entity @s item.components."minecraft:enchantments".levels."chakram:shadowstep" run return run function chakram:enchants/shadowstep/run
