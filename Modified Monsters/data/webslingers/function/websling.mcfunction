...
data modify entity @n[type=minecraft:falling_block,tag=webslinger_web] Motion set from entity @e[type=marker,tag=webslinger_direction,limit=1] Pos

kill @e[tag=webslinger_direction]
