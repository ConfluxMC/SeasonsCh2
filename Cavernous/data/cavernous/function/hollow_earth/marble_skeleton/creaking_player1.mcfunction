...
execute as @e[type=creaking,distance=..12,predicate=cavernous:marble_skeleton/target_holding_devotion_quartz] run function cavernous:hollow_earth/marble_skeleton/creaking_player2
