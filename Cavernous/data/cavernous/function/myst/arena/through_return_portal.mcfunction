...
data modify storage cavernous:storage spawn.x set from entity @s respawn.pos[0]
data modify storage cavernous:storage spawn.y set from entity @s respawn.pos[1]
data modify storage cavernous:storage spawn.z set from entity @s respawn.pos[2]
