summon creeper ~ ~ ~ {Fuse:30,ExplosionRadius:-3,CustomName:'Glob',Silent:1b,Tags:["glob","no_id","converted"],active_effects:[{id:invisibility,duration:-1,amplifier:0,show_particles:0b},{id:luck,duration:-1,amplifier:0,show_particles:0b}]}
