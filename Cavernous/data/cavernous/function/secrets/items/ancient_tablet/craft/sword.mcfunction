...
summon item ~ ~0.5 ~ {Item:{id:"minecraft:stone_sword",count:1,components:{unbreakable:{},tooltip_display:{hidden_components:[unbreakable]},repair_cost:1000,custom_data:{tag:ancient_blade},attribute_modifiers:{modifiers:[{type:attack_damage,amount:20,slot:"mainhand",id:"1",operation:"add_value"}]},item_name:[{"text":"Ancient Blade","italic":false,"color":"dark_red"}],lore:[[{"text":"Drains health while using","italic":false}]],enchantment_glint_override:true}}}
