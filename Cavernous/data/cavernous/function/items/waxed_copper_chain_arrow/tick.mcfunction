...
execute if score @s chain_arrow.timer matches 1 if block ~ ~ ~ #cavernous:torch_replaceable run setblock ~ ~ ~ waxed_copper_chain[axis=y]
execute if score @s chain_arrow.timer matches 2 if block ~ ~-1 ~ #cavernous:torch_replaceable run setblock ~ ~-1 ~ waxed_copper_chain[axis=y]
execute if score @s chain_arrow.timer matches 3 if block ~ ~-2 ~ #cavernous:torch_replaceable run setblock ~ ~-2 ~ waxed_copper_chain[axis=y]
execute if score @s chain_arrow.timer matches 4 if block ~ ~-3 ~ #cavernous:torch_replaceable run setblock ~ ~-3 ~ waxed_copper_chain[axis=y]
execute if score @s chain_arrow.timer matches 5 if block ~ ~-4 ~ #cavernous:torch_replaceable run setblock ~ ~-4 ~ waxed_copper_chain[axis=y]
execute if score @s chain_arrow.timer matches 6 if block ~ ~-5 ~ #cavernous:torch_replaceable run setblock ~ ~-5 ~ waxed_copper_chain[axis=y]
execute if score @s chain_arrow.timer matches 7 if block ~ ~-6 ~ #cavernous:torch_replaceable run setblock ~ ~-6 ~ waxed_copper_chain[axis=y]
execute if score @s chain_arrow.timer matches 8 if block ~ ~-7 ~ #cavernous:torch_replaceable run setblock ~ ~-7 ~ waxed_copper_chain[axis=y]
