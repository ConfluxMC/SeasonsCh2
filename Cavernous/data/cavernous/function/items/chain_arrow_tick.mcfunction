...
execute as @s[tag=chain_arrow_iron,tag=!chain_arrow_obstructed] if function cavernous:items/chain_arrow/place run return run playsound block.chain.place block @a ~ ~ ~ 1 1 0
execute as @s[tag=chain_arrow_copper,tag=!chain_arrow_obstructed] if function cavernous:items/copper_chain_arrow/place run return run playsound block.chain.place block @a ~ ~ ~ 1 1 0
execute as @s[tag=chain_arrow_waxed_copper,tag=!chain_arrow_obstructed] if function cavernous:items/waxed_copper_chain_arrow/place run return run playsound block.chain.place block @a ~ ~ ~ 1 1 0
...
execute if block ~ ~-1 ~ #minecraft:chains run return run function cavernous:items/chain_arrow_goto_lowest_chain
