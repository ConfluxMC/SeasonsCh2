execute if entity @s[predicate=geyser:can_be_placed] unless entity @e[type=!#geyser:can_place_block_on,tag=!geyser,distance=...81] run scoreboard players set @s geyser.can_place 1
