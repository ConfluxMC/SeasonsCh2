...
clear @a magma_cube_spawn_egg[entity_data={id:"armor_stand",Invisible:1b,Marker:1b,DisabledSlots:4144959,NoGravity:1b,Rotation:[0f,0f],Tags:[geyser],ArmorItems:[{},{},{},{id:player_head,components:{profile:{id:[I;1830371341,1597587671,-1944414330,67133243],name:"MagmaBlock",properties:[{value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNzIxZDA5MzBiZDYxZmVhNGNiOTAyN2IwMGU5NGUxM2Q2MjAyOWM1MjRlYTBiMzI2MGM3NDc0NTdiYTFiY2ZhMSJ9fX0=",name:textures}]}}}],ArmorDropChances:[0f,0f,0f,0f],CustomName:'[{"text":"Geyser Block","italic":false}]'},item_name='[{"text":"Geyser Block","italic":false}]'] 1
